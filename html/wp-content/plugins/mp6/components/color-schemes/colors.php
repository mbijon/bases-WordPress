...
// enqueue new color scheme picker (on profile screen)
add_action( 'admin_enqueue_scripts', 'mp6_colors_enqueue_picker_scripts' );
function mp6_colors_enqueue_picker_scripts() {
	if ( defined( 'IS_PROFILE_PAGE' ) ) {
		wp_enqueue_style( 'mp6-color-scheme-picker', plugins_url( 'picker/style.css', __FILE__ ) );
		wp_enqueue_script( 'mp6-color-scheme-picker', plugins_url( 'picker/scripts.js', __FILE__ ), array( 'jquery' ) );
	}
}
